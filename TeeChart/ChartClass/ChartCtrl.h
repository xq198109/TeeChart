...
public:
	...
	**/
	...
	void SetBorderColor(COLORREF NewCol)	{ m_BorderColor = NewCol;	/*RefreshChart(); */}
	...
	void SetZoomRectColor(COLORREF NewCol)	{ m_ZoomRectColor = NewCol; /*RefreshChart();*/ }
	...
	**/
	...
	//void SetChartCtrlRect(CRect rect);
	void SetPlottingRect(CRect rect);
...
private:
	...
	//自动调整绘图区大小，保证坐标轴的绘制范围
	void  DrawFigure(CDC* pDC,CRect FigureRect);

	void  AdjustPlotingRect(CDC* pDC, CRect PlottingRect,CRect& FigureRect);
	void  GetFigureRect(CDC* pDC, CRect PlottingRect, CRect& FigureRect);
